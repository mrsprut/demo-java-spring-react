...
class ProductStore {
    ...
    @action add() {
        commonStore.clearError()
        commonStore.setLoading(true)
        fetch(commonStore.basename + '/api/product', {
            method: 'POST',
            headers: {
    ...
    @action update () {
        commonStore.clearError()
        commonStore.setLoading(true)
        fetch(`${commonStore.basename}/api/product/${this.currentProduct.id}`,{
            method: 'PATCH',
            headers: {
                'Content-Type': 'application/json',
                'Accept': 'application/json'
    ...
    @action deleteProduct() {
        commonStore.clearError()
        commonStore.setLoading(true)
        fetch(commonStore.basename + '/api/product/' + this.currentProductId,{
            method: 'DELETE'
        }).then((response) => {
            return response.json()
        }).then(responseModel => {
    ...
    @action fetchProductPriceBounds() {
        commonStore.clearError()
        commonStore.setLoading(true)
        fetch(commonStore.basename + '/api/products/price-bounds', {
            method: 'GET'
        }).then((response) => {
            return response.json()
        }).then(responseModel => {
    ...
    @action fetchProductQuantityBounds() {
        commonStore.clearError()
        commonStore.setLoading(true)
        fetch(commonStore.basename + '/api/products/quantity-bounds', {
            method: 'GET'
        }).then((response) => {
            return response.json()
        }).then(responseModel => {
